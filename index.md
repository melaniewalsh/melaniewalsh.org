...
Additionally, I am co-editor of the [Post45 Data Collective](https://data.post45.org/our-data/) — a peer-reviewed, open-source repository for literary and cultural data after 1945. I am also co-PI of the [AI for Humanists project](http://www.bertforhumanists.org/) (formerly the BERT for Humanists project), which makes recent advances in artificial intelligence, like ChatGPT, GPT-3, and BERT, accessible to scholars in the humanities.
...
October 2022 | I published an essay on proprietary book data and open source alternatives, called ["Where Is All the Book Data?"](https://www.publicbooks.org/where-is-all-the-book-data/), in *Public Books*
